/*
Adapted from crossfold, available on SSC, authored by:
Benjamin Daniels
bbdaniels@gmail.com

Modifications allow for the use of pweights in the model block; all else is
unchanged. 
*/
...
syntax anything [pweight/] [if/] [in], [k(numlist min=1 max=1)] [EWeight(varname)] [eif(string)] [ein(string)] [stub(string)] [loud] [mae] [r2] * 
